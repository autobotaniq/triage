    ...
    <form method="post">
      <fieldset class="options">
        ...
        <select name="translit_standard">
          <option value="off"<?php if ($translit_standard == 'off') {
            echo(' selected="selected"');
          } ?>>Отключена
          </option>
          <option value="gost"<?php if ($translit_standard == 'gost') {
            echo(' selected="selected"');
          } ?>>ГОСТ 16876-71
          </option>
          <option value="iso"<?php if ($translit_standard == 'iso' OR $translit_standard == '') {
            echo(' selected="selected"');
          } ?>>ISO 9-95
          </option>
        </select>
